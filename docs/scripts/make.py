...
parser.add_argument("--index", dest="index", help="Without --all: build fish_genomics.html. With --all: exlude fish_genomics.html", action="store_true", default=False);
...
if pages['index']:
    os.system("Rscript fish_genomics_generator.r");
